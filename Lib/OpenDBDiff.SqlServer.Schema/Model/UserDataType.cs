                            ...
                            if (!fields.ContainsKey(column.FullName))
                            {
                                ...
                                if (!column.IsComputed)
                                {
                                   ...
                                   */
                                    ...
                                    list.Add(new SQLScript("ALTER TABLE " + column.Parent.FullName + " ALTER COLUMN " +
                                        column.ToSQLRedefine(Type, Size, null) + "\r\n", 0, ScriptAction.AlterColumn) { OBJECTNAME = Parent.Name, SCHEMA = Parent.Owner, OBJECTTYPE = ObjectType.Table, OBJECTSUBNAME = column.Name, StatusNew = ScriptActionNew.AlterTableModify });
